...
var MyForm = React.createClass({
  render: function() {
    ...
    return <form action={this.props.action} method={this.props.method}>Username: <input type="text" name="username" />
  Password: <input type="password" name="password" />
  <input type="submit" label={this.props.submitLabel} /></form>;
  }
});
