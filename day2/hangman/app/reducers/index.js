...
const rootReducer = combineReducers({
    ...
    badGuesses: badGuessesReducer, wordLetters: wordLettersReducer, guessedLetters: guessedLettersReducer, routing: routerReducer
    // this reducer is used by React Router in Redux
});
