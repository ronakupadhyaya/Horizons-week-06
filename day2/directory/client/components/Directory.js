...
const ppl = [
  ...
  { "fName": "Jeff", "lName": "Slam", "number": "(611)-845-0967", "email": "cmonandslam@welcometothejam.com" },
  { "fName": "Ffej", "lName": "Slam", "number": "(421)-845-0967", "email": "cmonandslam@welcometothejam.com" }
];
  ...
  render() {
    ...
    return person ? (
      <div>
        ...
        Not the {`${person.fName}`} you're looking for? <Link to={`/directory/${person.fName}`}>Find others</Link>
        <br></br>
